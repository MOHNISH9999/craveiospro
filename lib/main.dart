...
//
        ...
        children: [
          ...
          ElevatedButton(onPressed: (){
            Navigator.push(context, 
                  MaterialPageRoute(builder: ((context) =>ViewCustomeer() ))
                  );
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton.extended(
          ...
          onPressed: () {
            ...
            createuser(name: name2,email:email2,pincode:pin);
          },
    ...
    Future createuser( {
      required String name,email,pincode
  ...
  Map<String, dynamic> toJson() => {'id': id, 'name': name, 'email': email,'pincode':pincode};

  static Customer fromJson(Map<String, dynamic> json) =>
      Customer(name: json['name'], email: json['email'],pincode: json['pincode']);
}
